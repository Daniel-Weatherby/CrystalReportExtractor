...
namespace CrystalReportExtractor.Desktop
{
    internal sealed class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            {
                Text = "Select an input folder containing .rpt files and a separate output folder for analysed JSON metadata and portfolio CSV inventories.",
                AutoSize = true,
        ...
        private async void StartButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MessageBox.Show(
                    this,
                    string.Format(
                        "Reports found: {0}\nSucceeded: {1}\nFailed: {2}\nSkipped: {3}\n\nInventories:\ncrystal-report-inventory.csv\ncrystal-report-dependencies.csv",
